...
export const BUSINESS_CATEGORIES: BusinessCategory[] = [
  {
    ...
    microCopy: 'Grow it. Focus on your food and hospitality — KAI247 strengthens local discovery and customer engagement around your business.',
  ...
  },
  {
    ...
    microCopy: 'Grow it. KAI247 helps property owners across your city find your services 24×7.',
  ...
  },
  {
    ...
    microCopy: 'Strengthen it. KAI247 supports the digital and administrative business infrastructure around your patient care.',
  ...
  },
  {
    ...
    microCopy: 'You shouldn\'t have to build everything around it. KAI247 evolves the rest.',
...
export function BusinessEvolution() {
  ...
  return (
    <div className="k-business-evolution-stage">
      ...
      <div className="k-biz-diagram" role="img" aria-label="Diagram showing KAI247 capability nodes surrounding YOUR BUSINESS.">
        <svg viewBox="0 0 700 480" className="k-biz-svg">
          ...
          {/* CENTER NODE: YOUR BUSINESS (Not KAI247) */}
      ...
      <div className="k-biz-flow-grid">
        ...
        <div className="k-biz-flow-step">
          ...
          <p>Keep your name, look, and ownership. More capabilities arrive as KAI247 evolves 24×7.</p>
        </div>
      </div>
    </div>
  )
